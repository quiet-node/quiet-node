...
- 🛠 I’m currently working on:
   ...
   - 🌱 `NFTir` project, a Golang web server configured and deployed to an `AWS EC2` instance. Built on top of the `Gin Gonic` framework, `NFTir` hosted multiple RESTful endpoints that helps processing metadata and information of specific NFTs using `NFTGo API` (#golang, #aws, #ec2, #dynamoDB, #moralis, #web3.0, #nft, #ethereum)
